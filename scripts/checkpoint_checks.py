...
# model_dir = item_name("/gcohenlab/data/samuelgelman/data/ising_models/slow_learning_rate",p,secondary_keys)
model_dir = item_name("/gcohenlab/data/samuelgelman/data/ising_models/test",p,secondary_keys)
